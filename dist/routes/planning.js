...
export default async function planningRoutes(fastify) {
    ...
    fastify.get('/week', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.get('/month', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.post('/auto-schedule', { preHandler: [fastify.authenticate] }, async (request, reply) => {
